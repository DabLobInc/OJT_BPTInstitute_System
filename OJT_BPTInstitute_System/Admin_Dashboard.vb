Public Class Admin_Dashboard
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        SEval_DateTime.Text = DateTime.Now.ToString("MMMM dd, yyyy '//' hh:mm:ss tt")
    End Sub
    Private Sub SRegis_DateTime_Click(sender As Object, e As EventArgs) Handles SRegis_DateTime.Click
        SRegis_DateTime.Text = DateTime.Now.ToString("MMMM dd, yyyy '//' hh:mm:ss tt")
    End Sub
    Private Sub PComp_DateTime_Click(sender As Object, e As EventArgs) Handles PComp_DateTime.Click
        PComp_DateTime.Text = DateTime.Now.ToString("MMMM dd, yyyy '//' hh:mm:ss tt")
    End Sub
    Private Sub FEval_DateTime_Click(sender As Object, e As EventArgs) Handles FEval_DateTime.Click
        FEval_DateTime.Text = DateTime.Now.ToString("MMMM dd, yyyy '//' hh:mm:ss tt")
    End Sub
End Class
